...
Помимо прочего, благодаря способности автоматически преобразовывать используемые в своих сообщениях формулы LaTeX в изображения, Себастиан особенно хорош в обсуждении математических вопросов, а если захотите, то Себастиан скомпилирует и вашу формулу - просто попросите его об этом!
 ...
 *Не переживайте! Об этом инциденте уже сообщено, так что скоро проблема будет исправлена!*""",
 ...
 Among other topics of conversation, Sebastian is particularly great at mathematics. Thanks to his ability to instantly compile LaTeX formulas into images. He may also compile your formula, if you ask to!
...
`Note that OpenAI has quite a strict content policy which may result in error if your description is considered unethical. In this case just come up with another choice of words and try again.`
