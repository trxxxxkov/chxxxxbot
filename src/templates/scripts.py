scripts = {
    ...
    "err": {
        ...
        "balance is empty": {
            "en": "_You don't have enough funds to perform this request. You have to add funds to use GPT-4o and DALLE models.\n For more details, type /balance_",
            "ru": "_Недостаточно средств для оплаты вашего запроса. Пополните счёт, чтобы использовать модели GPT-4o и DALLE.\n Для получения информации о ценах и способах пополнения, введите команду /balance_",
        },
        "not privileged": {
    ...
    "bttn": {
        ...
        "redraw": {"en": "Draw similar images", "ru": "Нарисовать похожие изображения"},
