scripts = {
    "doc": {
        ...
        "draw": {
            "en": "_The command must have the following syntax:_\n\n `/draw YOUR_PROMPT`,\n\n_where_ `YOUR_PROMPT` _- is a description of an image you want._\n ||_After executing this command, you will receive an image with a __Draw Similar Images__ button. By clicking on it, you will be able to get two similar images._||",
            "ru": "_Команда должна иметь следующий вид:_\n\n `/draw ВАШ_ЗАПРОС`,\n\n_где_ `ВАШ_ЗАПРОС` _- описание изображения, которое вы хотите получить._\n ||_После выполнения этой команды вы получите изображение с кнопкой __Нарисовать похожие изображения__, нажав на которую вы сможете получить два похожих изображения._||",
        },
        "refund": {
        ...
        "pay": {
            "en": "_The command must have the following syntax:_\n\n `/pay STARS_AMOUNT`,\n\n_where_ `STARS_AMOUNT` _- is an integer between 1 and 2500. Each ⭐ is *{}* tokens._\n ||_After executing this command, you will receive a message with a __Pay to Sebastian__ button. By clicking on it, you will be able to make a payment for the specified amount of Telegram Stars._||",
            "ru": "_Команда должна иметь следующий вид:_\n\n `/pay ЧИСЛО_ЗВЁЗД`,\n\n_где_ `ЧИСЛО_ЗВЁЗД` _- целое число от 1 до 2500._ Одна ⭐ равняется *{}* токенам.\n ||_После выполнения этой команды вам будет отправлено сообщение с кнопкой __Заплатить Себастиану__, нажав которую вы сможете совершить оплату на указанную вами сумму Звёзд Telegram._||",
        },
        "payment description": {
