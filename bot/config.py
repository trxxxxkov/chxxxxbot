...
GLOBAL_SYSTEM_PROMPT = (
    ...
    "  - IMPORTANT: All voice messages, audio files, and videos are AUTO-TRANSCRIBED on upload!\n"
    "    The transcript appears in the message as [VOICE/AUDIO/VIDEO MESSAGE - Xs]: transcript...\n"
    "    DO NOT call transcribe_audio on files that already have transcripts in the message.\n"
    "    Only use transcribe_audio for files in 'Available files' that need re-transcription.\n\n"
