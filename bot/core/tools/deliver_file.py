...
Example: "Here are both charts" → deliver_file × 2 → both sent together

**SEQUENTIAL (sequential=true):**
Forces a turn break after delivery. You continue in next turn,
allowing text BETWEEN files.
Example:
  "Метод Эйлера..." → deliver_file(sequential=true) → file sent
  [new turn] "Метод Рунге-Кутты..." → deliver_file(sequential=true)
</delivery_modes>
